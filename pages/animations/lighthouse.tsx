    ...
    <div>
      ...
      <div className={styles.background}>
        <div className={styles.stars}>
          { stars.map((i, j) => { return <div className={styles.star} /> }) }
        </div>
        <div className={styles.moon}></div>
        <div className={styles.mountains}>
          { fours.map((i, j) => { return <div className={styles.mountain} /> }) }
        </div>
        <div className={styles.sea}>
          { waves.map((i, j) => { return <div className={styles.wave} /> }) }
      ...
      <div className={styles.lighthouseGroup}>
        ...
        <div className={styles.lighthouseHolder}>
          ...
          <div className={styles.windows}>
            { fours.map((i, j) => { return <div className={styles.window} /> }) }
          </div>
